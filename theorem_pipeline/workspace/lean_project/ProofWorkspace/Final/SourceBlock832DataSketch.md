# Frozen source data and power intervals for indices 832–863
...
- File: `SourceBlock832DataFull.lean`.
- Theorems: `sourceBlock832PiPairs_eq`, `sourceBlock832TwoPairs_eq`, `sourceBlock832Midpoints_eq_array`.
