# Frozen source data and power intervals for indices 8416–8447
...
- File: `SourceBlock8416DataFull.lean`.
- Theorems: `sourceBlock8416PiPairs_eq`, `sourceBlock8416TwoPairs_eq`, `sourceBlock8416Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8416Midpoints_slice_checked`.
