# Frozen source data and power intervals for indices 6080–6111
...
- File: `SourceBlock6080DataFull.lean`.
- Theorems: `sourceBlock6080PiPairs_eq`, `sourceBlock6080TwoPairs_eq`, `sourceBlock6080Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6080Midpoints_slice_checked`.
