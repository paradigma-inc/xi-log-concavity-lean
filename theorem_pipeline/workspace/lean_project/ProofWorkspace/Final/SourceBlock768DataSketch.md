# Frozen source data and power intervals for indices 768–799
...
- File: `SourceBlock768DataFull.lean`.
- Theorems: `sourceBlock768PiPairs_eq`, `sourceBlock768TwoPairs_eq`, `sourceBlock768Midpoints_eq_array`.
