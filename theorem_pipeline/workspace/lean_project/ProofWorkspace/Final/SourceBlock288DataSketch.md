# Frozen source data and power intervals for indices 288–319
...
- File: `SourceBlock288DataFull.lean`.
- Theorems: `sourceBlock288PiPairs_eq`, `sourceBlock288TwoPairs_eq`, `sourceBlock288Midpoints_eq_array`.
