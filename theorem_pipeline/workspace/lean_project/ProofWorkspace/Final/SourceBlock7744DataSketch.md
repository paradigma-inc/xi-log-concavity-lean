# Frozen source data and power intervals for indices 7744–7775
...
- File: `SourceBlock7744DataFull.lean`.
- Theorems: `sourceBlock7744PiPairs_eq`, `sourceBlock7744TwoPairs_eq`, `sourceBlock7744Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock7744Midpoints_slice_checked`.
