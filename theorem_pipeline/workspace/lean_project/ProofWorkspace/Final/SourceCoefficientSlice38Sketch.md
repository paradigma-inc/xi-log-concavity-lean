# Original coefficient source slice 38

## Statement

`sourceCoefficientSlice38_checked` identifies the proposed literal list with the exact original
source-array slice at indices $9728\le k<9984$. It supplies no
...
- File: `SourceCoefficientSlice38Full.lean`.
- Theorem: `sourceCoefficientSlice38_checked`.
