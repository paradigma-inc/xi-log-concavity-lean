# Original coefficient source slice 26

## Statement

`sourceCoefficientSlice26_checked` identifies the proposed literal list with the exact original
source-array slice at indices $6656\le k<6912$. It supplies no
...
- File: `SourceCoefficientSlice26Full.lean`.
- Theorem: `sourceCoefficientSlice26_checked`.
