# Original coefficient source slice 28

## Statement

`sourceCoefficientSlice28_checked` identifies the proposed literal list with the exact original
source-array slice at indices $7168\le k<7424$. It supplies no
...
- File: `SourceCoefficientSlice28Full.lean`.
- Theorem: `sourceCoefficientSlice28_checked`.
