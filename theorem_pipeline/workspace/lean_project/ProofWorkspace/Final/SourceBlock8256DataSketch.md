# Frozen source data and power intervals for indices 8256–8287
...
- File: `SourceBlock8256DataFull.lean`.
- Theorems: `sourceBlock8256PiPairs_eq`, `sourceBlock8256TwoPairs_eq`, `sourceBlock8256Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8256Midpoints_slice_checked`.
