# Original coefficient source slice 5

## Statement

`sourceCoefficientSlice05_checked` identifies the proposed literal list with the exact original
source-array slice at indices $1280\le k<1536$. It supplies no
...
- File: `SourceCoefficientSlice05Full.lean`.
- Theorem: `sourceCoefficientSlice05_checked`.
