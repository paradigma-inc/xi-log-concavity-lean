# Original coefficient source slice 34

## Statement

`sourceCoefficientSlice34_checked` identifies the proposed literal list with the exact original
source-array slice at indices $8704\le k<8960$. It supplies no
...
- File: `SourceCoefficientSlice34Full.lean`.
- Theorem: `sourceCoefficientSlice34_checked`.
