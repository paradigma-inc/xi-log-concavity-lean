# Original coefficient source slice 49

## Statement

`sourceCoefficientSlice49_checked` identifies the proposed literal list with the exact original
source-array slice at indices $12544\le k<12800$. It supplies no
...
- File: `SourceCoefficientSlice49Full.lean`.
- Theorem: `sourceCoefficientSlice49_checked`.
