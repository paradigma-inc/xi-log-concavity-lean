# Frozen source data and power intervals for indices 6336–6367
...
- File: `SourceBlock6336DataFull.lean`.
- Theorems: `sourceBlock6336PiPairs_eq`, `sourceBlock6336TwoPairs_eq`, `sourceBlock6336Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6336Midpoints_slice_checked`.
