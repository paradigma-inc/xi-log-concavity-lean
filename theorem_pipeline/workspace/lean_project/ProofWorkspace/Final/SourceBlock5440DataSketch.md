# Frozen source data and power intervals for indices 5440–5471
...
- File: `SourceBlock5440DataFull.lean`.
- Theorems: `sourceBlock5440PiPairs_eq`, `sourceBlock5440TwoPairs_eq`, `sourceBlock5440Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock5440Midpoints_slice_checked`.
