# Frozen source data and power intervals for indices 13600–13600

## Statement

The stored pi and base-two power pairs equal the existing outward-rounded retained-grid evaluators at all $1$ indices. The stored midpoints equal the corresponding entries of the frozen full source table.
...
- File: `SourceBlock13600DataFull.lean`.
- Theorems: `sourceBlock13600PiPairs_eq`, `sourceBlock13600TwoPairs_eq`, `sourceBlock13600Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock13600Midpoints_slice_checked`.
