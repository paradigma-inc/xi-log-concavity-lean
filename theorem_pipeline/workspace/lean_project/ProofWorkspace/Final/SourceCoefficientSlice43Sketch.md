# Original coefficient source slice 43

## Statement

`sourceCoefficientSlice43_checked` identifies the proposed literal list with the exact original
source-array slice at indices $11008\le k<11264$. It supplies no
...
- File: `SourceCoefficientSlice43Full.lean`.
- Theorem: `sourceCoefficientSlice43_checked`.
