# Frozen source data and power intervals for indices 640–671
...
- File: `SourceBlock640DataFull.lean`.
- Theorems: `sourceBlock640PiPairs_eq`, `sourceBlock640TwoPairs_eq`, `sourceBlock640Midpoints_eq_array`.
