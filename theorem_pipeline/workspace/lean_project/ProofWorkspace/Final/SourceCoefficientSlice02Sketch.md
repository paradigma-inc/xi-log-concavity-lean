# Original coefficient source slice 2

## Statement

`sourceCoefficientSlice02_checked` identifies the proposed literal list with the exact original
source-array slice at indices $512\le k<768$. It supplies no
...
- File: `SourceCoefficientSlice02Full.lean`.
- Theorem: `sourceCoefficientSlice02_checked`.
