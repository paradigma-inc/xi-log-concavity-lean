# Frozen source data and power intervals for indices 9024–9055
...
- File: `SourceBlock9024DataFull.lean`.
- Theorems: `sourceBlock9024PiPairs_eq`, `sourceBlock9024TwoPairs_eq`, `sourceBlock9024Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock9024Midpoints_slice_checked`.
