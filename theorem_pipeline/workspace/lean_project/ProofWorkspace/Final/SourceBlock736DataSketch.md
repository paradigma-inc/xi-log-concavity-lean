# Frozen source data and power intervals for indices 736–767
...
- File: `SourceBlock736DataFull.lean`.
- Theorems: `sourceBlock736PiPairs_eq`, `sourceBlock736TwoPairs_eq`, `sourceBlock736Midpoints_eq_array`.
