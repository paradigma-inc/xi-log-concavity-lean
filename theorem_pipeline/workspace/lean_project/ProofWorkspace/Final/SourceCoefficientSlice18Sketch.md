# Original coefficient source slice 18

## Statement

`sourceCoefficientSlice18_checked` identifies the proposed literal list with the exact original
source-array slice at indices $4608\le k<4864$. It supplies no
...
- File: `SourceCoefficientSlice18Full.lean`.
- Theorem: `sourceCoefficientSlice18_checked`.
