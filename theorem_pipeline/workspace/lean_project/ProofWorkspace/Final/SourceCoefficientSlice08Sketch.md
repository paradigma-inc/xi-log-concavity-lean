# Original coefficient source slice 8

## Statement

`sourceCoefficientSlice08_checked` identifies the proposed literal list with the exact original
source-array slice at indices $2048\le k<2304$. It supplies no
...
- File: `SourceCoefficientSlice08Full.lean`.
- Theorem: `sourceCoefficientSlice08_checked`.
