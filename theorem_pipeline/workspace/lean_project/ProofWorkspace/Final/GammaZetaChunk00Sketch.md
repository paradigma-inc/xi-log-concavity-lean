# Integer-zeta certificate packet 00

## Statement

The literal packet equals the established directed integer-zeta endpoint algorithm for all 40 integers $2\\le k\\le41$. The Euler order is $480$ and outward-rounding scale is $10^{180}$.
...
- File: `GammaZetaChunk00Full.lean`.
- Public theorem: `gammaZetaLiteralChunk00_eq`.
