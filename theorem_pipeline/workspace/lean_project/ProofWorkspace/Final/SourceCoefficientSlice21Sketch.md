# Original coefficient source slice 21

## Statement

`sourceCoefficientSlice21_checked` identifies the proposed literal list with the exact original
source-array slice at indices $5376\le k<5632$. It supplies no
...
- File: `SourceCoefficientSlice21Full.lean`.
- Theorem: `sourceCoefficientSlice21_checked`.
