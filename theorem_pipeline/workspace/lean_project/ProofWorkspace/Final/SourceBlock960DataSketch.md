# Frozen source data and power intervals for indices 960–991
...
- File: `SourceBlock960DataFull.lean`.
- Theorems: `sourceBlock960PiPairs_eq`, `sourceBlock960TwoPairs_eq`, `sourceBlock960Midpoints_eq_array`.
