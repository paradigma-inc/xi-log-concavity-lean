# Original coefficient source slice 27

## Statement

`sourceCoefficientSlice27_checked` identifies the proposed literal list with the exact original
source-array slice at indices $6912\le k<7168$. It supplies no
...
- File: `SourceCoefficientSlice27Full.lean`.
- Theorem: `sourceCoefficientSlice27_checked`.
