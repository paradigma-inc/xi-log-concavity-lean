# Original coefficient source slice 42

## Statement

`sourceCoefficientSlice42_checked` identifies the proposed literal list with the exact original
source-array slice at indices $10752\le k<11008$. It supplies no
...
- File: `SourceCoefficientSlice42Full.lean`.
- Theorem: `sourceCoefficientSlice42_checked`.
