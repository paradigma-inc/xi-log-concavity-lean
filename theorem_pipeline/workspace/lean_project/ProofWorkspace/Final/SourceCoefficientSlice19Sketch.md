# Original coefficient source slice 19

## Statement

`sourceCoefficientSlice19_checked` identifies the proposed literal list with the exact original
source-array slice at indices $4864\le k<5120$. It supplies no
...
- File: `SourceCoefficientSlice19Full.lean`.
- Theorem: `sourceCoefficientSlice19_checked`.
