# Frozen source data and power intervals for indices 8544–8575
...
- File: `SourceBlock8544DataFull.lean`.
- Theorems: `sourceBlock8544PiPairs_eq`, `sourceBlock8544TwoPairs_eq`, `sourceBlock8544Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8544Midpoints_slice_checked`.
