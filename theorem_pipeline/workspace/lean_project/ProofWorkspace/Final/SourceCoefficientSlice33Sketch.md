# Original coefficient source slice 33

## Statement

`sourceCoefficientSlice33_checked` identifies the proposed literal list with the exact original
source-array slice at indices $8448\le k<8704$. It supplies no
...
- File: `SourceCoefficientSlice33Full.lean`.
- Theorem: `sourceCoefficientSlice33_checked`.
