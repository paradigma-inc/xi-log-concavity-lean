# Frozen source data and power intervals for indices 8576–8607
...
- File: `SourceBlock8576DataFull.lean`.
- Theorems: `sourceBlock8576PiPairs_eq`, `sourceBlock8576TwoPairs_eq`, `sourceBlock8576Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8576Midpoints_slice_checked`.
