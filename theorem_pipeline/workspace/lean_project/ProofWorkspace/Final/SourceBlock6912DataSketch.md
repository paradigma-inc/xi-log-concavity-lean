# Frozen source data and power intervals for indices 6912–6943
...
- File: `SourceBlock6912DataFull.lean`.
- Theorems: `sourceBlock6912PiPairs_eq`, `sourceBlock6912TwoPairs_eq`, `sourceBlock6912Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6912Midpoints_slice_checked`.
