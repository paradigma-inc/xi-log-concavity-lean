# Original coefficient source slice 37

## Statement

`sourceCoefficientSlice37_checked` identifies the proposed literal list with the exact original
source-array slice at indices $9472\le k<9728$. It supplies no
...
- File: `SourceCoefficientSlice37Full.lean`.
- Theorem: `sourceCoefficientSlice37_checked`.
