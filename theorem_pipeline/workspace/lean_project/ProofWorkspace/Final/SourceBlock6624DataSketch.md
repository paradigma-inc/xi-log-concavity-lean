# Frozen source data and power intervals for indices 6624–6655
...
- File: `SourceBlock6624DataFull.lean`.
- Theorems: `sourceBlock6624PiPairs_eq`, `sourceBlock6624TwoPairs_eq`, `sourceBlock6624Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6624Midpoints_slice_checked`.
