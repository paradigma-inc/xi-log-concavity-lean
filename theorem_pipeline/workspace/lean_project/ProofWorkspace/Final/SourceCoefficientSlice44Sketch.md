# Original coefficient source slice 44

## Statement

`sourceCoefficientSlice44_checked` identifies the proposed literal list with the exact original
source-array slice at indices $11264\le k<11520$. It supplies no
...
- File: `SourceCoefficientSlice44Full.lean`.
- Theorem: `sourceCoefficientSlice44_checked`.
