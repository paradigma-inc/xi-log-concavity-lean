# Original coefficient source slice 11

## Statement

`sourceCoefficientSlice11_checked` identifies the proposed literal list with the exact original
source-array slice at indices $2816\le k<3072$. It supplies no
...
- File: `SourceCoefficientSlice11Full.lean`.
- Theorem: `sourceCoefficientSlice11_checked`.
