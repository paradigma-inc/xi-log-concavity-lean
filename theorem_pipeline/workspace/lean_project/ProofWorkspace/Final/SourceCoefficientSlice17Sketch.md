# Original coefficient source slice 17

## Statement

`sourceCoefficientSlice17_checked` identifies the proposed literal list with the exact original
source-array slice at indices $4352\le k<4608$. It supplies no
...
- File: `SourceCoefficientSlice17Full.lean`.
- Theorem: `sourceCoefficientSlice17_checked`.
