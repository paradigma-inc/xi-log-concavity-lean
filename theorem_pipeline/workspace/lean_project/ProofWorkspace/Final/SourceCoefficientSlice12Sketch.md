# Original coefficient source slice 12

## Statement

`sourceCoefficientSlice12_checked` identifies the proposed literal list with the exact original
source-array slice at indices $3072\le k<3328$. It supplies no
...
- File: `SourceCoefficientSlice12Full.lean`.
- Theorem: `sourceCoefficientSlice12_checked`.
