# Integer-zeta certificate packet 02

## Statement

The literal packet equals the established directed integer-zeta endpoint algorithm for all 40 integers $82\\le k\\le121$. The Euler order is $480$ and outward-rounding scale is $10^{180}$.
...
- File: `GammaZetaChunk02Full.lean`.
- Public theorem: `gammaZetaLiteralChunk02_eq`.
