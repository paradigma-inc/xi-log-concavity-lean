# Frozen source data and power intervals for indices 192–223
...
- File: `SourceBlock192DataFull.lean`.
- Theorems: `sourceBlock192PiPairs_eq`, `sourceBlock192TwoPairs_eq`, `sourceBlock192Midpoints_eq_array`.
