# Frozen source data and power intervals for indices 6720–6751
...
- File: `SourceBlock6720DataFull.lean`.
- Theorems: `sourceBlock6720PiPairs_eq`, `sourceBlock6720TwoPairs_eq`, `sourceBlock6720Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6720Midpoints_slice_checked`.
