# Frozen source data and power intervals for indices 3456–3487
...
- File: `SourceBlock3456DataFull.lean`.
- Theorems: `sourceBlock3456PiPairs_eq`, `sourceBlock3456TwoPairs_eq`, `sourceBlock3456Midpoints_eq_array`.
