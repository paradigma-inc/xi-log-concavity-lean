# Frozen source data and power intervals for indices 416–447
...
- File: `SourceBlock416DataFull.lean`.
- Theorems: `sourceBlock416PiPairs_eq`, `sourceBlock416TwoPairs_eq`, `sourceBlock416Midpoints_eq_array`.
