# Integer-zeta certificate packet 04

## Statement

The literal packet equals the established directed integer-zeta endpoint algorithm for all 40 integers $162\\le k\\le201$. The Euler order is $480$ and outward-rounding scale is $10^{180}$.
...
- File: `GammaZetaChunk04Full.lean`.
- Public theorem: `gammaZetaLiteralChunk04_eq`.
