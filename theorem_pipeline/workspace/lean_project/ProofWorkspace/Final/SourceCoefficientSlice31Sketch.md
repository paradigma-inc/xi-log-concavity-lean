# Original coefficient source slice 31

## Statement

`sourceCoefficientSlice31_checked` identifies the proposed literal list with the exact original
source-array slice at indices $7936\le k<8192$. It supplies no
...
- File: `SourceCoefficientSlice31Full.lean`.
- Theorem: `sourceCoefficientSlice31_checked`.
