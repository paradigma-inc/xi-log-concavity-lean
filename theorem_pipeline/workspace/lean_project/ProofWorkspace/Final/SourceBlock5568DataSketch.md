# Frozen source data and power intervals for indices 5568–5599
...
- File: `SourceBlock5568DataFull.lean`.
- Theorems: `sourceBlock5568PiPairs_eq`, `sourceBlock5568TwoPairs_eq`, `sourceBlock5568Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock5568Midpoints_slice_checked`.
