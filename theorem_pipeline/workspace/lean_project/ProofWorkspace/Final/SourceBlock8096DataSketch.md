# Frozen source data and power intervals for indices 8096–8127
...
- File: `SourceBlock8096DataFull.lean`.
- Theorems: `sourceBlock8096PiPairs_eq`, `sourceBlock8096TwoPairs_eq`, `sourceBlock8096Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8096Midpoints_slice_checked`.
