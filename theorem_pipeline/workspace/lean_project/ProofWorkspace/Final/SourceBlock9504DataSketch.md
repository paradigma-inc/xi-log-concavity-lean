# Frozen source data and power intervals for indices 9504–9535
...
- File: `SourceBlock9504DataFull.lean`.
- Theorems: `sourceBlock9504PiPairs_eq`, `sourceBlock9504TwoPairs_eq`, `sourceBlock9504Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock9504Midpoints_slice_checked`.
