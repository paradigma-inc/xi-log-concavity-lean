# Original coefficient source slice 46

## Statement

`sourceCoefficientSlice46_checked` identifies the proposed literal list with the exact original
source-array slice at indices $11776\le k<12032$. It supplies no
...
- File: `SourceCoefficientSlice46Full.lean`.
- Theorem: `sourceCoefficientSlice46_checked`.
