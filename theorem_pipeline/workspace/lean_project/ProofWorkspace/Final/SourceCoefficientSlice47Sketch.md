# Original coefficient source slice 47

## Statement

`sourceCoefficientSlice47_checked` identifies the proposed literal list with the exact original
source-array slice at indices $12032\le k<12288$. It supplies no
...
- File: `SourceCoefficientSlice47Full.lean`.
- Theorem: `sourceCoefficientSlice47_checked`.
