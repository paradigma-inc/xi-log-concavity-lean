# Original coefficient source slice 22

## Statement

`sourceCoefficientSlice22_checked` identifies the proposed literal list with the exact original
source-array slice at indices $5632\le k<5888$. It supplies no
...
- File: `SourceCoefficientSlice22Full.lean`.
- Theorem: `sourceCoefficientSlice22_checked`.
