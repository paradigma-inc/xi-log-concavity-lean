# Frozen source data and power intervals for indices 544–575
...
- File: `SourceBlock544DataFull.lean`.
- Theorems: `sourceBlock544PiPairs_eq`, `sourceBlock544TwoPairs_eq`, `sourceBlock544Midpoints_eq_array`.
