# Frozen source data and power intervals for indices 8192–8223
...
- File: `SourceBlock8192DataFull.lean`.
- Theorems: `sourceBlock8192PiPairs_eq`, `sourceBlock8192TwoPairs_eq`, `sourceBlock8192Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8192Midpoints_slice_checked`.
