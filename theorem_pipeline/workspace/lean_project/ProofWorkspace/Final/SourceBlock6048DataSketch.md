# Frozen source data and power intervals for indices 6048–6079
...
- File: `SourceBlock6048DataFull.lean`.
- Theorems: `sourceBlock6048PiPairs_eq`, `sourceBlock6048TwoPairs_eq`, `sourceBlock6048Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6048Midpoints_slice_checked`.
