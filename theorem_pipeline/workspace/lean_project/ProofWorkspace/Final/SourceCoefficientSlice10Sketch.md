# Original coefficient source slice 10

## Statement

`sourceCoefficientSlice10_checked` identifies the proposed literal list with the exact original
source-array slice at indices $2560\le k<2816$. It supplies no
...
- File: `SourceCoefficientSlice10Full.lean`.
- Theorem: `sourceCoefficientSlice10_checked`.
