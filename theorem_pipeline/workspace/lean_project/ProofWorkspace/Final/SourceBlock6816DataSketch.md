# Frozen source data and power intervals for indices 6816–6847
...
- File: `SourceBlock6816DataFull.lean`.
- Theorems: `sourceBlock6816PiPairs_eq`, `sourceBlock6816TwoPairs_eq`, `sourceBlock6816Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6816Midpoints_slice_checked`.
