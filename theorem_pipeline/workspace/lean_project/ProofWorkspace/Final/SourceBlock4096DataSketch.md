# Frozen source data and power intervals for indices 4096–4127
...
- File: `SourceBlock4096DataFull.lean`.
- Theorems: `sourceBlock4096PiPairs_eq`, `sourceBlock4096TwoPairs_eq`, `sourceBlock4096Midpoints_eq_array`.
