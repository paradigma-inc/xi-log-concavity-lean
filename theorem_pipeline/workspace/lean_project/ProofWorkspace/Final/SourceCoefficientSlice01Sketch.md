# Original coefficient source slice 1

## Statement

`sourceCoefficientSlice01_checked` identifies the proposed literal list with the exact original
source-array slice at indices $256\le k<512$. It supplies no
...
- File: `SourceCoefficientSlice01Full.lean`.
- Theorem: `sourceCoefficientSlice01_checked`.
