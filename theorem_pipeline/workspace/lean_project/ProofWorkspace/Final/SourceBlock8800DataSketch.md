# Frozen source data and power intervals for indices 8800–8831
...
- File: `SourceBlock8800DataFull.lean`.
- Theorems: `sourceBlock8800PiPairs_eq`, `sourceBlock8800TwoPairs_eq`, `sourceBlock8800Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8800Midpoints_slice_checked`.
