# Frozen source data and power intervals for indices 224–255
...
- File: `SourceBlock224DataFull.lean`.
- Theorems: `sourceBlock224PiPairs_eq`, `sourceBlock224TwoPairs_eq`, `sourceBlock224Midpoints_eq_array`.
