# Original coefficient source slice 45

## Statement

`sourceCoefficientSlice45_checked` identifies the proposed literal list with the exact original
source-array slice at indices $11520\le k<11776$. It supplies no
...
- File: `SourceCoefficientSlice45Full.lean`.
- Theorem: `sourceCoefficientSlice45_checked`.
