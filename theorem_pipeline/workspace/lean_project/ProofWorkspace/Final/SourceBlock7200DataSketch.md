# Frozen source data and power intervals for indices 7200–7231
...
- File: `SourceBlock7200DataFull.lean`.
- Theorems: `sourceBlock7200PiPairs_eq`, `sourceBlock7200TwoPairs_eq`, `sourceBlock7200Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock7200Midpoints_slice_checked`.
