# Frozen source data and power intervals for indices 800–831
...
- File: `SourceBlock800DataFull.lean`.
- Theorems: `sourceBlock800PiPairs_eq`, `sourceBlock800TwoPairs_eq`, `sourceBlock800Midpoints_eq_array`.
