# Frozen source data and power intervals for indices 8672–8703
...
- File: `SourceBlock8672DataFull.lean`.
- Theorems: `sourceBlock8672PiPairs_eq`, `sourceBlock8672TwoPairs_eq`, `sourceBlock8672Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8672Midpoints_slice_checked`.
