# Frozen source data and power intervals for indices 3776–3807
...
- File: `SourceBlock3776DataFull.lean`.
- Theorems: `sourceBlock3776PiPairs_eq`, `sourceBlock3776TwoPairs_eq`, `sourceBlock3776Midpoints_eq_array`.
