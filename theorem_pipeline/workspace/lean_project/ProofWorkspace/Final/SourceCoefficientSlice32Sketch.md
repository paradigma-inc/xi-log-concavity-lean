# Original coefficient source slice 32

## Statement

`sourceCoefficientSlice32_checked` identifies the proposed literal list with the exact original
source-array slice at indices $8192\le k<8448$. It supplies no
...
- File: `SourceCoefficientSlice32Full.lean`.
- Theorem: `sourceCoefficientSlice32_checked`.
