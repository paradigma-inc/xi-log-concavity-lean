# Frozen source data and power intervals for indices 448–479
...
- File: `SourceBlock448DataFull.lean`.
- Theorems: `sourceBlock448PiPairs_eq`, `sourceBlock448TwoPairs_eq`, `sourceBlock448Midpoints_eq_array`.
