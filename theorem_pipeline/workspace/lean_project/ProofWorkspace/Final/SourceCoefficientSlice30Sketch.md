# Original coefficient source slice 30

## Statement

`sourceCoefficientSlice30_checked` identifies the proposed literal list with the exact original
source-array slice at indices $7680\le k<7936$. It supplies no
...
- File: `SourceCoefficientSlice30Full.lean`.
- Theorem: `sourceCoefficientSlice30_checked`.
