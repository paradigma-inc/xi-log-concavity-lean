# Original coefficient source slice 40

## Statement

`sourceCoefficientSlice40_checked` identifies the proposed literal list with the exact original
source-array slice at indices $10240\le k<10496$. It supplies no
...
- File: `SourceCoefficientSlice40Full.lean`.
- Theorem: `sourceCoefficientSlice40_checked`.
