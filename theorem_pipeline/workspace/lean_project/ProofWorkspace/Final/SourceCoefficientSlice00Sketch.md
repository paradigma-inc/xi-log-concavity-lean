# Original coefficient source slice 0

## Statement

`sourceCoefficientSlice00_checked` identifies the proposed literal list with the exact original
source-array slice at indices $0\le k<256$. It supplies no
...
- File: `SourceCoefficientSlice00Full.lean`.
- Theorem: `sourceCoefficientSlice00_checked`.
