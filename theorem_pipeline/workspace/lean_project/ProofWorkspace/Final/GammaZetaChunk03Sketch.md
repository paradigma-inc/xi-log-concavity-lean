# Integer-zeta certificate packet 03

## Statement

The literal packet equals the established directed integer-zeta endpoint algorithm for all 40 integers $122\\le k\\le161$. The Euler order is $480$ and outward-rounding scale is $10^{180}$.
...
- File: `GammaZetaChunk03Full.lean`.
- Public theorem: `gammaZetaLiteralChunk03_eq`.
