# Frozen source data and power intervals for indices 8352–8383
...
- File: `SourceBlock8352DataFull.lean`.
- Theorems: `sourceBlock8352PiPairs_eq`, `sourceBlock8352TwoPairs_eq`, `sourceBlock8352Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8352Midpoints_slice_checked`.
