# Frozen source data and power intervals for indices 352–383
...
- File: `SourceBlock352DataFull.lean`.
- Theorems: `sourceBlock352PiPairs_eq`, `sourceBlock352TwoPairs_eq`, `sourceBlock352Midpoints_eq_array`.
