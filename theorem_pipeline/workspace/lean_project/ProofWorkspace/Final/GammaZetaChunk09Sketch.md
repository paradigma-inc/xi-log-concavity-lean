# Integer-zeta certificate packet 09

## Statement

The literal packet equals the established directed integer-zeta endpoint algorithm for all 40 integers $362\\le k\\le401$. The Euler order is $480$ and outward-rounding scale is $10^{180}$.
...
- File: `GammaZetaChunk09Full.lean`.
- Public theorem: `gammaZetaLiteralChunk09_eq`.
