# Frozen source data and power intervals for indices 7168–7199
...
- File: `SourceBlock7168DataFull.lean`.
- Theorems: `sourceBlock7168PiPairs_eq`, `sourceBlock7168TwoPairs_eq`, `sourceBlock7168Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock7168Midpoints_slice_checked`.
