# Frozen source data and power intervals for indices 8608–8639
...
- File: `SourceBlock8608DataFull.lean`.
- Theorems: `sourceBlock8608PiPairs_eq`, `sourceBlock8608TwoPairs_eq`, `sourceBlock8608Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8608Midpoints_slice_checked`.
