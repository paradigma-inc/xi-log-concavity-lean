# Frozen source data and power intervals for indices 672–703
...
- File: `SourceBlock672DataFull.lean`.
- Theorems: `sourceBlock672PiPairs_eq`, `sourceBlock672TwoPairs_eq`, `sourceBlock672Midpoints_eq_array`.
