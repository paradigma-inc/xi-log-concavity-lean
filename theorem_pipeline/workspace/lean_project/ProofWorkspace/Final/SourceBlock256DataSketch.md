# Frozen source data and power intervals for indices 256–287
...
- File: `SourceBlock256DataFull.lean`.
- Theorems: `sourceBlock256PiPairs_eq`, `sourceBlock256TwoPairs_eq`, `sourceBlock256Midpoints_eq_array`.
