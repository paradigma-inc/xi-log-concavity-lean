# Frozen source data and power intervals for indices 1024–1055
...
- File: `SourceBlock1024DataFull.lean`.
- Theorems: `sourceBlock1024PiPairs_eq`, `sourceBlock1024TwoPairs_eq`, `sourceBlock1024Midpoints_eq_array`.
