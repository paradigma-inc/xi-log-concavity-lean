# Frozen source data and power intervals for indices 5728–5759
...
- File: `SourceBlock5728DataFull.lean`.
- Theorems: `sourceBlock5728PiPairs_eq`, `sourceBlock5728TwoPairs_eq`, `sourceBlock5728Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock5728Midpoints_slice_checked`.
