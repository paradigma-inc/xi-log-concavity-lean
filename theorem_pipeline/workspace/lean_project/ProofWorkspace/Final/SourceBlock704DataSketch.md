# Frozen source data and power intervals for indices 704–735
...
- File: `SourceBlock704DataFull.lean`.
- Theorems: `sourceBlock704PiPairs_eq`, `sourceBlock704TwoPairs_eq`, `sourceBlock704Midpoints_eq_array`.
