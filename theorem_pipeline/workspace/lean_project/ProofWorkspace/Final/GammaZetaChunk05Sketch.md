# Integer-zeta certificate packet 05

## Statement

The literal packet equals the established directed integer-zeta endpoint algorithm for all 40 integers $202\\le k\\le241$. The Euler order is $480$ and outward-rounding scale is $10^{180}$.
...
- File: `GammaZetaChunk05Full.lean`.
- Public theorem: `gammaZetaLiteralChunk05_eq`.
