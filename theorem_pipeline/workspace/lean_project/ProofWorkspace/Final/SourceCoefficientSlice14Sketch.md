# Original coefficient source slice 14

## Statement

`sourceCoefficientSlice14_checked` identifies the proposed literal list with the exact original
source-array slice at indices $3584\le k<3840$. It supplies no
...
- File: `SourceCoefficientSlice14Full.lean`.
- Theorem: `sourceCoefficientSlice14_checked`.
