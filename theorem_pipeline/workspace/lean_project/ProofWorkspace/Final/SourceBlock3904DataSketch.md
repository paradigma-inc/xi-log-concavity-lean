# Frozen source data and power intervals for indices 3904–3935
...
- File: `SourceBlock3904DataFull.lean`.
- Theorems: `sourceBlock3904PiPairs_eq`, `sourceBlock3904TwoPairs_eq`, `sourceBlock3904Midpoints_eq_array`.
