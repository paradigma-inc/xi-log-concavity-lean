# Frozen source data and power intervals for indices 4000–4031
...
- File: `SourceBlock4000DataFull.lean`.
- Theorems: `sourceBlock4000PiPairs_eq`, `sourceBlock4000TwoPairs_eq`, `sourceBlock4000Midpoints_eq_array`.
