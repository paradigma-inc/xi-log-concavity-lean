# Original coefficient source slice 24

## Statement

`sourceCoefficientSlice24_checked` identifies the proposed literal list with the exact original
source-array slice at indices $6144\le k<6400$. It supplies no
...
- File: `SourceCoefficientSlice24Full.lean`.
- Theorem: `sourceCoefficientSlice24_checked`.
