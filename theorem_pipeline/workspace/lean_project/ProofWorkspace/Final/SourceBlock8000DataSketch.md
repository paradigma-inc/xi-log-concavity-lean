# Frozen source data and power intervals for indices 8000–8031
...
- File: `SourceBlock8000DataFull.lean`.
- Theorems: `sourceBlock8000PiPairs_eq`, `sourceBlock8000TwoPairs_eq`, `sourceBlock8000Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8000Midpoints_slice_checked`.
