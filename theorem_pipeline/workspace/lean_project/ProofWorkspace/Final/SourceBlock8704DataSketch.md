# Frozen source data and power intervals for indices 8704–8735
...
- File: `SourceBlock8704DataFull.lean`.
- Theorems: `sourceBlock8704PiPairs_eq`, `sourceBlock8704TwoPairs_eq`, `sourceBlock8704Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8704Midpoints_slice_checked`.
