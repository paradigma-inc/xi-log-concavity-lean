# Original coefficient source slice 35

## Statement

`sourceCoefficientSlice35_checked` identifies the proposed literal list with the exact original
source-array slice at indices $8960\le k<9216$. It supplies no
...
- File: `SourceCoefficientSlice35Full.lean`.
- Theorem: `sourceCoefficientSlice35_checked`.
