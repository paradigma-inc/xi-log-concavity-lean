# Frozen source data and power intervals for indices 864–895
...
- File: `SourceBlock864DataFull.lean`.
- Theorems: `sourceBlock864PiPairs_eq`, `sourceBlock864TwoPairs_eq`, `sourceBlock864Midpoints_eq_array`.
