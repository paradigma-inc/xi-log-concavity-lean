# Original coefficient source slice 13

## Statement

`sourceCoefficientSlice13_checked` identifies the proposed literal list with the exact original
source-array slice at indices $3328\le k<3584$. It supplies no
...
- File: `SourceCoefficientSlice13Full.lean`.
- Theorem: `sourceCoefficientSlice13_checked`.
