# Original coefficient source slice 7

## Statement

`sourceCoefficientSlice07_checked` identifies the proposed literal list with the exact original
source-array slice at indices $1792\le k<2048$. It supplies no
...
- File: `SourceCoefficientSlice07Full.lean`.
- Theorem: `sourceCoefficientSlice07_checked`.
