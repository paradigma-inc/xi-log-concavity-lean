# Original coefficient source slice 41

## Statement

`sourceCoefficientSlice41_checked` identifies the proposed literal list with the exact original
source-array slice at indices $10496\le k<10752$. It supplies no
...
- File: `SourceCoefficientSlice41Full.lean`.
- Theorem: `sourceCoefficientSlice41_checked`.
