# Frozen source data and power intervals for indices 608–639
...
- File: `SourceBlock608DataFull.lean`.
- Theorems: `sourceBlock608PiPairs_eq`, `sourceBlock608TwoPairs_eq`, `sourceBlock608Midpoints_eq_array`.
