# Original coefficient source slice 39

## Statement

`sourceCoefficientSlice39_checked` identifies the proposed literal list with the exact original
source-array slice at indices $9984\le k<10240$. It supplies no
...
- File: `SourceCoefficientSlice39Full.lean`.
- Theorem: `sourceCoefficientSlice39_checked`.
