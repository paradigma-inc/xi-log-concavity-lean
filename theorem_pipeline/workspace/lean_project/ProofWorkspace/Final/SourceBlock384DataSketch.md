# Frozen source data and power intervals for indices 384–415
...
- File: `SourceBlock384DataFull.lean`.
- Theorems: `sourceBlock384PiPairs_eq`, `sourceBlock384TwoPairs_eq`, `sourceBlock384Midpoints_eq_array`.
