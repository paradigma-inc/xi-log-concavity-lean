# Frozen source data and power intervals for indices 6240–6271
...
- File: `SourceBlock6240DataFull.lean`.
- Theorems: `sourceBlock6240PiPairs_eq`, `sourceBlock6240TwoPairs_eq`, `sourceBlock6240Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6240Midpoints_slice_checked`.
