# Frozen source data and power intervals for indices 8160–8191
...
- File: `SourceBlock8160DataFull.lean`.
- Theorems: `sourceBlock8160PiPairs_eq`, `sourceBlock8160TwoPairs_eq`, `sourceBlock8160Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8160Midpoints_slice_checked`.
