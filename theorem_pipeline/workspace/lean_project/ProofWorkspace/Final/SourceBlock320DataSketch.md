# Frozen source data and power intervals for indices 320–351
...
- File: `SourceBlock320DataFull.lean`.
- Theorems: `sourceBlock320PiPairs_eq`, `sourceBlock320TwoPairs_eq`, `sourceBlock320Midpoints_eq_array`.
