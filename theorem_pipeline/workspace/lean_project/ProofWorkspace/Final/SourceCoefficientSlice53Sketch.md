# Original coefficient source slice 53

## Statement

`sourceCoefficientSlice53_checked` identifies the proposed literal list with the exact original
source-array slice at indices $13568\le k<13601$. It supplies no
...
- File: `SourceCoefficientSlice53Full.lean`.
- Theorem: `sourceCoefficientSlice53_checked`.
