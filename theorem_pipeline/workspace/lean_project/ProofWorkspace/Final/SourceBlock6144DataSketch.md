# Frozen source data and power intervals for indices 6144–6175
...
- File: `SourceBlock6144DataFull.lean`.
- Theorems: `sourceBlock6144PiPairs_eq`, `sourceBlock6144TwoPairs_eq`, `sourceBlock6144Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6144Midpoints_slice_checked`.
