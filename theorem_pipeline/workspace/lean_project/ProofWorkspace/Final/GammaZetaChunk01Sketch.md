# Integer-zeta certificate packet 01

## Statement

The literal packet equals the established directed integer-zeta endpoint algorithm for all 40 integers $42\\le k\\le81$. The Euler order is $480$ and outward-rounding scale is $10^{180}$.
...
- File: `GammaZetaChunk01Full.lean`.
- Public theorem: `gammaZetaLiteralChunk01_eq`.
