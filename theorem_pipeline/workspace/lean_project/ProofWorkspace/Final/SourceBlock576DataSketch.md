# Frozen source data and power intervals for indices 576–607
...
- File: `SourceBlock576DataFull.lean`.
- Theorems: `sourceBlock576PiPairs_eq`, `sourceBlock576TwoPairs_eq`, `sourceBlock576Midpoints_eq_array`.
