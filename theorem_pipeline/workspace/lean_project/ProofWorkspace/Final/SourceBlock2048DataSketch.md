# Frozen source data and power intervals for indices 2048–2079
...
- File: `SourceBlock2048DataFull.lean`.
- Theorems: `sourceBlock2048PiPairs_eq`, `sourceBlock2048TwoPairs_eq`, `sourceBlock2048Midpoints_eq_array`.
