# Original coefficient source slice 25

## Statement

`sourceCoefficientSlice25_checked` identifies the proposed literal list with the exact original
source-array slice at indices $6400\le k<6656$. It supplies no
...
- File: `SourceCoefficientSlice25Full.lean`.
- Theorem: `sourceCoefficientSlice25_checked`.
