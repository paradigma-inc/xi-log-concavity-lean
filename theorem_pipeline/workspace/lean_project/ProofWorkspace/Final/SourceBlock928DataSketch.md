# Frozen source data and power intervals for indices 928–959
...
- File: `SourceBlock928DataFull.lean`.
- Theorems: `sourceBlock928PiPairs_eq`, `sourceBlock928TwoPairs_eq`, `sourceBlock928Midpoints_eq_array`.
