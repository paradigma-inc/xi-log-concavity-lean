# Frozen source data and power intervals for indices 512–543
...
- File: `SourceBlock512DataFull.lean`.
- Theorems: `sourceBlock512PiPairs_eq`, `sourceBlock512TwoPairs_eq`, `sourceBlock512Midpoints_eq_array`.
