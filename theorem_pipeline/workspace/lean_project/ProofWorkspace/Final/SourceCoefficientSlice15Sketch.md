# Original coefficient source slice 15

## Statement

`sourceCoefficientSlice15_checked` identifies the proposed literal list with the exact original
source-array slice at indices $3840\le k<4096$. It supplies no
...
- File: `SourceCoefficientSlice15Full.lean`.
- Theorem: `sourceCoefficientSlice15_checked`.
