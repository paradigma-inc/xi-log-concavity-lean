# Original coefficient source slice 3

## Statement

`sourceCoefficientSlice03_checked` identifies the proposed literal list with the exact original
source-array slice at indices $768\le k<1024$. It supplies no
...
- File: `SourceCoefficientSlice03Full.lean`.
- Theorem: `sourceCoefficientSlice03_checked`.
