# Frozen source data and power intervals for indices 9728–9759
...
- File: `SourceBlock9728DataFull.lean`.
- Theorems: `sourceBlock9728PiPairs_eq`, `sourceBlock9728TwoPairs_eq`, `sourceBlock9728Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock9728Midpoints_slice_checked`.
