# Frozen source data and power intervals for indices 896–927
...
- File: `SourceBlock896DataFull.lean`.
- Theorems: `sourceBlock896PiPairs_eq`, `sourceBlock896TwoPairs_eq`, `sourceBlock896Midpoints_eq_array`.
