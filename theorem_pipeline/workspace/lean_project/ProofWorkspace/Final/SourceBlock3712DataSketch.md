# Frozen source data and power intervals for indices 3712–3743
...
- File: `SourceBlock3712DataFull.lean`.
- Theorems: `sourceBlock3712PiPairs_eq`, `sourceBlock3712TwoPairs_eq`, `sourceBlock3712Midpoints_eq_array`.
