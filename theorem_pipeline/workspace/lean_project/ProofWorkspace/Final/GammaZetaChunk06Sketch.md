# Integer-zeta certificate packet 06

## Statement

The literal packet equals the established directed integer-zeta endpoint algorithm for all 40 integers $242\\le k\\le281$. The Euler order is $480$ and outward-rounding scale is $10^{180}$.
...
- File: `GammaZetaChunk06Full.lean`.
- Public theorem: `gammaZetaLiteralChunk06_eq`.
