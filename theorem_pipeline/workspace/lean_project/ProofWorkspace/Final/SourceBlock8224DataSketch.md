# Frozen source data and power intervals for indices 8224–8255
...
- File: `SourceBlock8224DataFull.lean`.
- Theorems: `sourceBlock8224PiPairs_eq`, `sourceBlock8224TwoPairs_eq`, `sourceBlock8224Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8224Midpoints_slice_checked`.
