# Original coefficient source slice 9

## Statement

`sourceCoefficientSlice09_checked` identifies the proposed literal list with the exact original
source-array slice at indices $2304\le k<2560$. It supplies no
...
- File: `SourceCoefficientSlice09Full.lean`.
- Theorem: `sourceCoefficientSlice09_checked`.
