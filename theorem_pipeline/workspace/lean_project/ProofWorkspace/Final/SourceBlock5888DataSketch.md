# Frozen source data and power intervals for indices 5888–5919
...
- File: `SourceBlock5888DataFull.lean`.
- Theorems: `sourceBlock5888PiPairs_eq`, `sourceBlock5888TwoPairs_eq`, `sourceBlock5888Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock5888Midpoints_slice_checked`.
