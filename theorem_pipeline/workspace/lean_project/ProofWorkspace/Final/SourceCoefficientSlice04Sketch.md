# Original coefficient source slice 4

## Statement

`sourceCoefficientSlice04_checked` identifies the proposed literal list with the exact original
source-array slice at indices $1024\le k<1280$. It supplies no
...
- File: `SourceCoefficientSlice04Full.lean`.
- Theorem: `sourceCoefficientSlice04_checked`.
