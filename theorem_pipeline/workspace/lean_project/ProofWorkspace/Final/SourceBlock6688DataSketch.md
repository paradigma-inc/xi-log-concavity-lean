# Frozen source data and power intervals for indices 6688–6719
...
- File: `SourceBlock6688DataFull.lean`.
- Theorems: `sourceBlock6688PiPairs_eq`, `sourceBlock6688TwoPairs_eq`, `sourceBlock6688Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6688Midpoints_slice_checked`.
