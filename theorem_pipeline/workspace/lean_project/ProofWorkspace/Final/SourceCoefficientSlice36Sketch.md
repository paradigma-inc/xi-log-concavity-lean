# Original coefficient source slice 36

## Statement

`sourceCoefficientSlice36_checked` identifies the proposed literal list with the exact original
source-array slice at indices $9216\le k<9472$. It supplies no
...
- File: `SourceCoefficientSlice36Full.lean`.
- Theorem: `sourceCoefficientSlice36_checked`.
