# Original coefficient source slice 16

## Statement

`sourceCoefficientSlice16_checked` identifies the proposed literal list with the exact original
source-array slice at indices $4096\le k<4352$. It supplies no
...
- File: `SourceCoefficientSlice16Full.lean`.
- Theorem: `sourceCoefficientSlice16_checked`.
