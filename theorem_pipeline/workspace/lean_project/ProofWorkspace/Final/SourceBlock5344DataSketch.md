# Frozen source data and power intervals for indices 5344–5375
...
- File: `SourceBlock5344DataFull.lean`.
- Theorems: `sourceBlock5344PiPairs_eq`, `sourceBlock5344TwoPairs_eq`, `sourceBlock5344Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock5344Midpoints_slice_checked`.
