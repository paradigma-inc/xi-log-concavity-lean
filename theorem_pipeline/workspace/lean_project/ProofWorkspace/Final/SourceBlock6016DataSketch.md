# Frozen source data and power intervals for indices 6016–6047
...
- File: `SourceBlock6016DataFull.lean`.
- Theorems: `sourceBlock6016PiPairs_eq`, `sourceBlock6016TwoPairs_eq`, `sourceBlock6016Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6016Midpoints_slice_checked`.
