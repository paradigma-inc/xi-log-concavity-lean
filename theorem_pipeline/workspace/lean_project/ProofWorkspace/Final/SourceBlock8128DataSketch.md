# Frozen source data and power intervals for indices 8128–8159
...
- File: `SourceBlock8128DataFull.lean`.
- Theorems: `sourceBlock8128PiPairs_eq`, `sourceBlock8128TwoPairs_eq`, `sourceBlock8128Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8128Midpoints_slice_checked`.
