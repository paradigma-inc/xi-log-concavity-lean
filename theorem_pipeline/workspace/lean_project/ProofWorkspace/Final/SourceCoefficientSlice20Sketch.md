# Original coefficient source slice 20

## Statement

`sourceCoefficientSlice20_checked` identifies the proposed literal list with the exact original
source-array slice at indices $5120\le k<5376$. It supplies no
...
- File: `SourceCoefficientSlice20Full.lean`.
- Theorem: `sourceCoefficientSlice20_checked`.
