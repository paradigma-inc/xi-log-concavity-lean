# Frozen source data and power intervals for indices 6304–6335
...
- File: `SourceBlock6304DataFull.lean`.
- Theorems: `sourceBlock6304PiPairs_eq`, `sourceBlock6304TwoPairs_eq`, `sourceBlock6304Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock6304Midpoints_slice_checked`.
