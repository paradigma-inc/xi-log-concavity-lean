# Frozen source data and power intervals for indices 480–511
...
- File: `SourceBlock480DataFull.lean`.
- Theorems: `sourceBlock480PiPairs_eq`, `sourceBlock480TwoPairs_eq`, `sourceBlock480Midpoints_eq_array`.
