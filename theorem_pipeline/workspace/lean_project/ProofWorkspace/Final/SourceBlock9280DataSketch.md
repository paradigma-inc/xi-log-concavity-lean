# Frozen source data and power intervals for indices 9280–9311
...
- File: `SourceBlock9280DataFull.lean`.
- Theorems: `sourceBlock9280PiPairs_eq`, `sourceBlock9280TwoPairs_eq`, `sourceBlock9280Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock9280Midpoints_slice_checked`.
