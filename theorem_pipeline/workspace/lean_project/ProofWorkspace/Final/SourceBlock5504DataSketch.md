# Frozen source data and power intervals for indices 5504–5535
...
- File: `SourceBlock5504DataFull.lean`.
- Theorems: `sourceBlock5504PiPairs_eq`, `sourceBlock5504TwoPairs_eq`, `sourceBlock5504Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock5504Midpoints_slice_checked`.
