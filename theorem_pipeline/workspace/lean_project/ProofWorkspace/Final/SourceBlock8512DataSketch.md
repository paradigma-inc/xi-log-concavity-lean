# Frozen source data and power intervals for indices 8512–8543
...
- File: `SourceBlock8512DataFull.lean`.
- Theorems: `sourceBlock8512PiPairs_eq`, `sourceBlock8512TwoPairs_eq`, `sourceBlock8512Midpoints_eq_array`.
- Additional exact slice theorem: `sourceBlock8512Midpoints_slice_checked`.
